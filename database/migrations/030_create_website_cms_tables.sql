...
CREATE TABLE IF NOT EXISTS website_general_settings (
    ...
    tagline VARCHAR(255) NOT NULL DEFAULT 'Together We Shape the Future',
...
CREATE TABLE IF NOT EXISTS website_hero_settings (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    hero_badge VARCHAR(255) NOT NULL DEFAULT 'Together We Shape the Future',
    hero_title VARCHAR(255) NOT NULL DEFAULT 'Musyawarah Terpadu',
    ...
    primary_cta_label VARCHAR(100) NOT NULL DEFAULT 'Daftar Calon Ketua Umum',
    primary_cta_url VARCHAR(255) NOT NULL DEFAULT '/register/candidate',
    primary_cta_enabled BOOLEAN NOT NULL DEFAULT true,
    secondary_cta_label VARCHAR(100) NOT NULL DEFAULT 'Daftar Peserta Musyawarah',
    secondary_cta_url VARCHAR(255) NOT NULL DEFAULT '/register',
