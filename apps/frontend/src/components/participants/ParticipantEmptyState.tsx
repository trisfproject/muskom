...
export function ParticipantEmptyState({ onClearFilters }: ParticipantEmptyStateProps) {
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4 border border-dashed border-slate-300 rounded-lg bg-slate-50 text-center">
      ...
      <p className="text-slate-500 max-w-sm mb-6 text-sm">
        We couldn&apos;t find any participants matching your current search or filter criteria.
      </p>
      {onClearFilters && (
