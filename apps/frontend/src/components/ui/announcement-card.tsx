  ...
  ({ className, category, title, summary, date, thumbnailUrl, isLatest, onClick, ...props }, ref) => {
    return (
      ...
      >
        ...
        {thumbnailUrl && (
          <div className="w-full h-44 mb-5 overflow-hidden rounded-xl border border-light dark:border-slate-800 bg-slate-100 dark:bg-slate-800">
        ...
        <h3 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white mb-2.5 group-hover:text-primary transition-colors leading-snug">
          {title}
        </h3>

        <p className="text-xs sm:text-sm text-muted leading-relaxed line-clamp-3 mb-6 flex-1">
          {summary}
        </p>
