        ...
        <div className="col-span-1">
          {action ? (
            <div className={`bg-${action.color}-500/10 border border-${action.color}-500/20 rounded-xl p-6 sticky top-24`}>
              ...
              <Link 
                href={action.href}
                className={`w-full flex items-center justify-center gap-2 bg-${action.color}-600 hover:bg-${action.color}-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors`}
              >
                {action.label}
