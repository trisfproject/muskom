  ...
  return (
    <div className="p-8 max-w-5xl">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        <div>
          <h1 className="text-2xl font-bold text-white tracking-tight">Website — Pusat Informasi & Pengumuman</h1>
            ...
            <form onSubmit={handleSave} className="p-6 space-y-4">
              ...
              <div className="space-y-2 pt-2">
                <label className="flex items-center gap-3 p-3 bg-[var(--color-bg)]/60 border border-[var(--color-border)] rounded-xl cursor-pointer">
                  ...
                  />
                  <div>
                    <span className="text-xs font-bold text-white block">Sematkan di Atas (Pin)</span>
                    <span className="text-[11px] text-slate-400">Tampilkan sebagai berita prioritas/terbaru</span>
                  </div>
                </label>
                ...
                <label className="flex items-center gap-3 p-3 bg-[var(--color-bg)]/60 border border-[var(--color-border)] rounded-xl cursor-pointer">
                  ...
                  />
                  <div>
                    <span className="text-xs font-bold text-white block">Publikasikan</span>
                    <span className="text-[11px] text-slate-400">Tampilkan di halaman portal publik</span>
                  </div>
                </label>
              </div>
