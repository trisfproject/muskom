  ...
  return (
    <div className="p-8 max-w-5xl">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        <div>
          <h1 className="text-2xl font-bold text-white tracking-tight">Website — Timeline & Agenda</h1>
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400 line-clamp-1">{phase.description || "Tidak ada deskripsi."}</p>
            ...
            <form onSubmit={handleSave} className="p-6 space-y-4">
              ...
              <div className="space-y-2 pt-2">
                <label className="flex items-center gap-3 p-3 bg-slate-950/60 border border-slate-800 rounded-xl cursor-pointer">
                  ...
                  />
                  <div>
                    <span className="text-xs font-bold text-white block">Tandai Sebagai Fase Aktif</span>
                    <span className="text-[11px] text-slate-400">Override manual indikator fase aktif di landing</span>
                  </div>
                </label>
                ...
                <label className="flex items-center gap-3 p-3 bg-slate-950/60 border border-slate-800 rounded-xl cursor-pointer">
                  ...
                  />
                  <div>
                    <span className="text-xs font-bold text-white block">Publikasikan Tahapan Ini</span>
                    <span className="text-[11px] text-slate-400">Tampilkan di halaman publik</span>
                  </div>
                </label>
              </div>
