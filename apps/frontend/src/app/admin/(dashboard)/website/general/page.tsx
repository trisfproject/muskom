    ...
    <div className="p-8 max-w-4xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="pg-surface border pg-border rounded-2xl p-6">
          <h2 className="text-base font-semibold pg-text mb-4">Identitas Website</h2>
        ...
        {/* Tema & Warna */}
        <div className="pg-surface border pg-border rounded-2xl p-6">
          <h2 className="text-base font-semibold pg-text mb-4">Tema & Warna</h2>
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                <input
                  ...
                  value={formData.primary_color}
                  onChange={(e) => setFormData({ ...formData, primary_color: e.target.value })}
                  className="flex-1 bg-[var(--color-bg)] border pg-border rounded-xl px-3.5 py-2.5 text-sm pg-text font-mono"
                />
              </div>
            </div>
            <div>
        ...
        {/* Kontrol Akses & Fitur */}
        <div className="pg-surface border pg-border rounded-2xl p-6">
          <h2 className="text-base font-semibold pg-text mb-4">Fitur & Mode Portal</h2>
          <div className="space-y-4">
            <label className="flex items-center justify-between p-3.5 bg-[var(--color-bg)]/60 border pg-border/80 rounded-xl cursor-pointer hover:pg-border transition-colors">
              <div>
                <span className="text-sm font-medium pg-text block">Registrasi Aktif</span>
                <span className="text-xs pg-muted">Izinkan peserta dan bakal calon mengakses formulir pendaftaran</span>
              </div>
              <input
                type="checkbox"
            ...
            <label className="flex items-center justify-between p-3.5 bg-[var(--color-bg)]/60 border pg-border/80 rounded-xl cursor-pointer hover:pg-border transition-colors">
              <div>
                <span className="text-sm font-medium pg-text block">Mode Perawatan (Maintenance Mode)</span>
        ...
        {/* SEO & Metadata */}
        <div className="pg-surface border pg-border rounded-2xl p-6">
          <h2 className="text-base font-semibold pg-text mb-4">Search Engine Optimization (SEO)</h2>
          <div className="space-y-4">
            <div>
