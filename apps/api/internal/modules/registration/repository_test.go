...
func TestRepository_GetRegistrationAdminByID(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		rows := sqlmock.NewRows([]string{
			"id", "event_id", "registration_number", "event_name", "participant_name", "nickname",
			"email", "phone", "company", "job_title", "region", "community",
			"participant_category", "source", "status", "special_notes", "created_at", "updated_at",
		}).
			AddRow("reg1", "evt1", "REG-001", "Event 1", "John Doe", "Johnny", "john@test.com", "123", "Acme", "Dev", "Jakarta", "IT", "DELEGATE", "WEB", "PENDING", "", "2023-01-01", "2023-01-01")
